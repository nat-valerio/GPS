...
public class MainActivity extends AppCompatActivity {
    ...
    private Location catedralLocalizacao = new Location("Localização da catedral");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Verificação de permissão de uso do GPS
        if (checkSelfPermission(Manifest.permission.ACCESS_FINE_LOCATION)
            ...
            ActivityCompat.requestPermissions(this, new String[]{
                    Manifest.permission.ACCESS_FINE_LOCATION}, CODIGO_REQUISICAO
        ...
        fusedLocClient.getLastLocation().addOnSuccessListener(this, new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                if (location != null){
                    ...
                    //Armazena as informções da posição
    ...
    public void calcularDistancia(View v){
        ...
        //Aproximar a distancia
        /*Double distanciaAprox = Math.ceil(distancia.doubleValue());
        distancia = distanciaAprox.floatValue()/1000;*/
    }
}
